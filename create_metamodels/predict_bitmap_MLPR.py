...
x_train = np.load('NPY_FILES/final_disp_train.npy')
y_train = np.load('NPY_FILES/MNIST_bitmap_train.npy')

x_test = np.load('NPY_FILES/final_disp_test.npy')
y_test = np.load('NPY_FILES/MNIST_bitmap_test.npy')
